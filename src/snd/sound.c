...
bool sound_handle_get_u8(struct Context *this, uint16_t address, uint8_t *ret_value) {
    switch (address) {
        case 0xff10: // NR10 - Channel 1 Sweep register (R/W)
            *ret_value = this->sound.NR10.raw | 0x80;
            return true;
        ...
        case 0xff1a: // NR30 - Channel 3 Sound on/off (R/W)
            *ret_value = this->sound.NR30 | 0x7f;
            return true;
        case 0xff1c: // NR32 - Channel 3 Select output level (R/W)
            *ret_value = this->sound.NR32.raw | 0x9f;
            return true;
...
bool sound_handle_set_u8(struct Context *this, uint16_t address, uint8_t value) {
    if (this->sound.sound_enabled) {
        switch (address) {
            case 0xff10: // NR10 - Channel 1 Sweep register (R/W)
                ...
                this->sound.channel01.freq_sweep.period = this->sound.NR10.sweep_time;
                return true;
            case 0xff11: // NR11 - Channel 1 Sound length/Wave pattern duty (R/W)
            ...
            case 0xff12: // NR12 - Channel 1 Volume Envelope (R/W)
                ...
                if (this->sound.NR12.initial_envelope_volume == 0) {
                    this->sound.channel01.enabled = false;
                }
                this->sound.channel01.envelope.volume = this->sound.NR12.initial_envelope_volume;
                this->sound.channel01.envelope.period = this->sound.NR12.number_envelope_sweep;
                this->sound.channel01.envelope.enabled = this->sound.NR12.number_envelope_sweep > 0;
                return true;
            case 0xff13: // NR13 - Channel 1 Frequency lo (Write Only)
            ...
            case 0xff14: // NR14 - Channel 1 Frequency hi (R/W)
                ...
                if (value & 0x80) {
                    ...
                    this->sound.channel01.envelope.period = this->sound.NR12.number_envelope_sweep;
                    this->sound.channel01.envelope.enabled = this->sound.NR12.number_envelope_sweep > 0;
                    this->sound.channel01.freq_sweep.enabled = (this->sound.NR10.sweep_shift > 0)
                        || (this->sound.NR10.sweep_time > 0);
                    this->sound.channel01.freq_sweep.period = this->sound.NR10.sweep_time;
                    if (this->sound.NR10.sweep_shift > 0) {
            ...
            case 0xff17: // NR22 - Channel 2 Volume Envelope (R/W)
                ...
                if (this->sound.NR22.initial_envelope_volume == 0) {
                    this->sound.channel02.enabled = false;
                }
                this->sound.channel02.envelope.volume = this->sound.NR22.initial_envelope_volume;
                this->sound.channel02.envelope.period = this->sound.NR22.number_envelope_sweep;
                this->sound.channel02.envelope.enabled = this->sound.NR22.number_envelope_sweep > 0;
                return true;
            ...
            case 0xff21: // NR42 - Channel 4 Volume Envelope (R/W)
                ...
                if (this->sound.NR42.initial_envelope_volume == 0) {
                    this->sound.channel04.enabled = false;
                }
                this->sound.channel04.envelope.volume = this->sound.NR42.initial_envelope_volume;
                this->sound.channel04.envelope.period = this->sound.NR42.number_envelope_sweep;
                this->sound.channel04.envelope.enabled = this->sound.NR42.number_envelope_sweep > 0;
                return true;
            case 0xff22: // NR43 - Channel 4 Polynomial Counter (R/W)
    ...
    if (address == 0xff26) { // NR52 - Sound on/off
        if (value & 0x80) {
            ...
            this->sound.channel03.enabled = false;
            this->sound.channel04.enabled = false;
            this->sound.NR10.raw = 0;
            this->sound.NR11.raw = 0;
            this->sound.NR12.raw = 0;
            this->sound.NR13_14.NRx3_raw = 0;
            this->sound.NR13_14.NRx4_raw = 0;
            this->sound.NR21.raw = 0;
            this->sound.NR22.raw = 0;
            this->sound.NR23_24.NRx3_raw = 0;
            this->sound.NR23_24.NRx4_raw = 0;
            this->sound.NR30 = 0;
            this->sound.NR31 = 0;
            this->sound.NR32.raw = 0;
            this->sound.NR33_34.NRx3_raw = 0;
            this->sound.NR33_34.NRx4_raw = 0;
            this->sound.NR41.raw = 0;
            this->sound.NR42.raw = 0;
            this->sound.NR43.raw = 0;
            this->sound.NR44.raw = 0;
            this->sound.NR50.raw = 0;
            this->sound.NR51.raw = 0;
        }
        return true;
    }
